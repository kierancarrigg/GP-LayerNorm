...
class Blocks3Norm1(EvolvedLayer):
    ...
    Equation: 0.507*clip(4.33*x)
    """
    def forward(self, x):
        x_norm = 0.507*clip(4.33*x)
...
class Blocks4Norm1(EvolvedLayer):
    ...
    Equation: neg(clip(-2.16*x))
    """
    def forward(self, x):
        x_norm = neg(clip(-2.16*x))
...
class Blocks5Norm2(EvolvedLayer):
    ...
    Equation: 0.579*clip(3.77*x) + 0.225
    """
    def forward(self, x):
        x_norm = 0.579*clip(3.77*x) + 0.225
...
class Blocks6Norm1(EvolvedLayer):
    ...
    Equation: -0.552*neg(clip(3.97*x) + 0.411)
    """
    def forward(self, x):
        x_norm = -0.552*neg(clip(3.97*x) + 0.411)
...
class Blocks8Norm1(EvolvedLayer):
    ...
    Equation: -0.123*x + 1.67*clip(x)
    """
    def forward(self, x):
        x_norm = -0.123*x + 1.67*clip(x)
...
class Blocks9Norm1(EvolvedLayer):
    ...
    Equation: 0.512*clip(2.5*x + 0.386)
    """
    def forward(self, x):
        x_norm = 0.512*clip(2.5*x + 0.386)
...
class Blocks10Norm1(EvolvedLayer):
    ...
    Equation: clip(x) + clip(0.164 - 0.0294*x)
    """
    def forward(self, x):
        x_norm = clip(x) + clip(0.164 - 0.0294*x)
...
class Blocks10Norm2(EvolvedLayer):
    ...
    Equation: 0.435*clip(2*x)
    """
    def forward(self, x):
        x_norm = 0.435*clip(2*x)
