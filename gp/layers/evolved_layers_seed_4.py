...
class Blocks0Norm2(EvolvedLayer):
    ...
    Equation: 0.712*clip(2.26*x)
    """
    def forward(self, x):
        x_norm = 0.712*clip(2.26*x)
...
class Blocks2Norm1(EvolvedLayer):
    ...
    Equation: -0.561*x + clip(2.67*x)
    """
    def forward(self, x):
        x_norm = -0.561*x + clip(2.67*x)
...
class Blocks3Norm1(EvolvedLayer):
    ...
    Equation: -0.261*x + clip(2.48*x) + 0.159
    """
    def forward(self, x):
        x_norm = -0.261*x + clip(2.48*x) + 0.159
...
class Blocks7Norm2(EvolvedLayer):
    ...
    Equation: -0.573*clip(-2.89*x)
    """
    def forward(self, x):
        x_norm = -0.573*clip(-2.89*x)
...
class Blocks9Norm1(EvolvedLayer):
    ...
    Equation: -0.49*neg(clip(2.58*x) + 0.386)
    """
    def forward(self, x):
        x_norm = -0.49*neg(clip(2.58*x) + 0.386)
...
class Blocks10Norm1(EvolvedLayer):
    ...
    Equation: 0.472*clip(2*x)
    """
    def forward(self, x):
        x_norm = 0.472*clip(2*x)
...
class Blocks10Norm2(EvolvedLayer):
    ...
    Equation: clip(-0.127*x) + clip(x)
    """
    def forward(self, x):
        x_norm = clip(-0.127*x) + clip(x)
