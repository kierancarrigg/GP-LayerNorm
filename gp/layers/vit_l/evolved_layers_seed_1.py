...
class Blocks0Norm1(EvolvedLayer):
    ...
    Equation: -0.205*x + 1.11*clip(x)
    """
    def forward(self, x):
        x_norm = -0.205*x + 1.11*clip(x)
...
class Blocks0Norm2(EvolvedLayer):
    ...
    Equation: -0.386*x + 1.39*clip(x)
    """
    def forward(self, x):
        x_norm = -0.386*x + 1.39*clip(x)
...
class Blocks2Norm2(EvolvedLayer):
    ...
    Equation: -0.192*x + 1.27*clip(x)
    """
    def forward(self, x):
        x_norm = -0.192*x + 1.27*clip(x)
...
class Blocks3Norm1(EvolvedLayer):
    ...
    Equation: 0.536*clip(2.04*x)
    """
    def forward(self, x):
        x_norm = 0.536*clip(2.04*x)
...
class Blocks3Norm2(EvolvedLayer):
    ...
    Equation: 0.525*clip(2.12*x)
    """
    def forward(self, x):
        x_norm = 0.525*clip(2.12*x)
...
class Blocks4Norm1(EvolvedLayer):
    ...
    Equation: clip(-1.1*neg(x))
    """
    def forward(self, x):
        x_norm = clip(-1.1*neg(x))
...
class Blocks4Norm2(EvolvedLayer):
    ...
    Equation: -0.737*x + 1.81*clip(x)
    """
    def forward(self, x):
        x_norm = -0.737*x + 1.81*clip(x)
...
class Blocks5Norm1(EvolvedLayer):
    ...
    Equation: -0.0979*x + clip(1.19*x)
    """
    def forward(self, x):
        x_norm = -0.0979*x + clip(1.19*x)
...
class Blocks6Norm1(EvolvedLayer):
    ...
    Equation: 0.496*clip(2.24*x)
    """
    def forward(self, x):
        x_norm = 0.496*clip(2.24*x)
...
class Blocks6Norm2(EvolvedLayer):
    ...
    Equation: 0.499*clip(2.29*x)
    """
    def forward(self, x):
        x_norm = 0.499*clip(2.29*x)
...
class Blocks7Norm1(EvolvedLayer):
    ...
    Equation: 0.536*clip(2.13*x)
    """
    def forward(self, x):
        x_norm = 0.536*clip(2.13*x)
...
class Blocks7Norm2(EvolvedLayer):
    ...
    Equation: -0.0896*x + clip(x)
    """
    def forward(self, x):
        x_norm = -0.0896*x + clip(x)
...
class Blocks9Norm2(EvolvedLayer):
    ...
    Equation: -0.222*x + 1.34*clip(x)
    """
    def forward(self, x):
        x_norm = -0.222*x + 1.34*clip(x)
...
class Blocks10Norm2(EvolvedLayer):
    ...
    Equation: -0.159*x + 1.28*clip(x)
    """
    def forward(self, x):
        x_norm = -0.159*x + 1.28*clip(x)
...
class Blocks11Norm2(EvolvedLayer):
    ...
    Equation: -0.121*x + 1.19*clip(x)
    """
    def forward(self, x):
        x_norm = -0.121*x + 1.19*clip(x)
...
class Blocks12Norm1(EvolvedLayer):
    ...
    Equation: -0.0371*x + clip(x)
    """
    def forward(self, x):
        x_norm = -0.0371*x + clip(x)
...
class Blocks12Norm2(EvolvedLayer):
    ...
    Equation: 0.519*clip(1.96*x)
    """
    def forward(self, x):
        x_norm = 0.519*clip(1.96*x)
...
class Blocks13Norm1(EvolvedLayer):
    ...
    Equation: 0.496*clip(2.01*x)
    """
    def forward(self, x):
        x_norm = 0.496*clip(2.01*x)
...
class Blocks15Norm1(EvolvedLayer):
    ...
    Equation: 0.45*clip(1.93*x)
    """
    def forward(self, x):
        x_norm = 0.45*clip(1.93*x)
...
class Blocks15Norm2(EvolvedLayer):
    ...
    Equation: -0.011*x + 0.813*clip(x)
    """
    def forward(self, x):
        x_norm = -0.011*x + 0.813*clip(x)
...
class Blocks16Norm1(EvolvedLayer):
    ...
    Equation: 0.442*clip(1.78*x)
    """
    def forward(self, x):
        x_norm = 0.442*clip(1.78*x)
...
class Blocks17Norm1(EvolvedLayer):
    ...
    Equation: 0.448*clip(1.62*x)
    """
    def forward(self, x):
        x_norm = 0.448*clip(1.62*x)
...
class Blocks18Norm1(EvolvedLayer):
    ...
    Equation: 0.435*clip(1.57*x)
    """
    def forward(self, x):
        x_norm = 0.435*clip(1.57*x)
...
class Blocks22Norm2(EvolvedLayer):
    ...
    Equation: -0.391*neg(clip(x))
    """
    def forward(self, x):
        x_norm = -0.391*neg(clip(x))
...
class Blocks23Norm2(EvolvedLayer):
    ...
    Equation: -0.362*neg(clip(x))
    """
    def forward(self, x):
        x_norm = -0.362*neg(clip(x))
