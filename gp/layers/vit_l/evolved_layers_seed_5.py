...
class Blocks0Norm1(EvolvedLayer):
    ...
    Equation: -0.163*x + clip(x)
    """
    def forward(self, x):
        x_norm = -0.163*x + clip(x)
...
class Blocks0Norm2(EvolvedLayer):
    ...
    Equation: -0.356*x + 1.29*clip(1.06*x)
    """
    def forward(self, x):
        x_norm = -0.356*x + 1.29*clip(1.06*x)
...
class Blocks1Norm1(EvolvedLayer):
    ...
    Equation: -0.154*x + clip(x)
    """
    def forward(self, x):
        x_norm = -0.154*x + clip(x)
...
class Blocks1Norm2(EvolvedLayer):
    ...
    Equation: neg(0.452*x - 1.5*clip(x))
    """
    def forward(self, x):
        x_norm = neg(0.452*x - 1.5*clip(x))
...
class Blocks2Norm1(EvolvedLayer):
    ...
    Equation: -0.07*x + clip(x)
    """
    def forward(self, x):
        x_norm = -0.07*x + clip(x)
...
class Blocks3Norm1(EvolvedLayer):
    ...
    Equation: 0.542*clip(2.07*x)
    """
    def forward(self, x):
        x_norm = 0.542*clip(2.07*x)
...
class Blocks4Norm2(EvolvedLayer):
    ...
    Equation: clip(clip(-0.386*x + clip(1.46*x)))
    """
    def forward(self, x):
        x_norm = clip(clip(-0.386*x + clip(1.46*x)))
...
class Blocks5Norm1(EvolvedLayer):
    ...
    Equation: -0.0861*x + clip(x)
    """
    def forward(self, x):
        x_norm = -0.0861*x + clip(x)
...
class Blocks5Norm2(EvolvedLayer):
    ...
    Equation: 0.491*clip(2.23*x)
    """
    def forward(self, x):
        x_norm = 0.491*clip(2.23*x)
...
class Blocks6Norm1(EvolvedLayer):
    ...
    Equation: 0.5*clip(2.26*x)
    """
    def forward(self, x):
        x_norm = 0.5*clip(2.26*x)
...
class Blocks8Norm1(EvolvedLayer):
    ...
    Equation: 0.526*clip(2.25*x)
    """
    def forward(self, x):
        x_norm = 0.526*clip(2.25*x)
...
class Blocks8Norm2(EvolvedLayer):
    ...
    Equation: -0.146*x + 1.29*clip(x)
    """
    def forward(self, x):
        x_norm = -0.146*x + 1.29*clip(x)
...
class Blocks9Norm2(EvolvedLayer):
    ...
    Equation: 0.529*clip(2.12*x)
    """
    def forward(self, x):
        x_norm = 0.529*clip(2.12*x)
...
class Blocks10Norm1(EvolvedLayer):
    ...
    Equation: clip(-1.15*neg(x))
    """
    def forward(self, x):
        x_norm = clip(-1.15*neg(x))
...
class Blocks11Norm2(EvolvedLayer):
    ...
    Equation: -0.117*x + 1.19*clip(x)
    """
    def forward(self, x):
        x_norm = -0.117*x + 1.19*clip(x)
...
class Blocks12Norm1(EvolvedLayer):
    ...
    Equation: 0.53*clip(2*x)
    """
    def forward(self, x):
        x_norm = 0.53*clip(2*x)
...
class Blocks12Norm2(EvolvedLayer):
    ...
    Equation: -0.0479*x + clip(x)
    """
    def forward(self, x):
        x_norm = -0.0479*x + clip(x)
...
class Blocks13Norm1(EvolvedLayer):
    ...
    Equation: 0.499*clip(2*x)
    """
    def forward(self, x):
        x_norm = 0.499*clip(2*x)
...
class Blocks13Norm2(EvolvedLayer):
    ...
    Equation: 0.518*clip(1.81*x)
    """
    def forward(self, x):
        x_norm = 0.518*clip(1.81*x)
...
class Blocks14Norm1(EvolvedLayer):
    ...
    Equation: 0.488*clip(1.89*x)
    """
    def forward(self, x):
        x_norm = 0.488*clip(1.89*x)
...
class Blocks14Norm2(EvolvedLayer):
    ...
    Equation: 0.49*clip(1.81*x)
    """
    def forward(self, x):
        x_norm = 0.49*clip(1.81*x)
...
class Blocks16Norm1(EvolvedLayer):
    ...
    Equation: 0.44*clip(1.79*x)
    """
    def forward(self, x):
        x_norm = 0.44*clip(1.79*x)
...
class Blocks16Norm2(EvolvedLayer):
    ...
    Equation: 0.457*clip(1.63*x)
    """
    def forward(self, x):
        x_norm = 0.457*clip(1.63*x)
